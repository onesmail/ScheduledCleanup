...
namespace ScheduledCleanup
{
    public partial class Form1 : Form
    {
        ...
        {
            timer.Interval = DataConfigHelper.DataConfig.Config.Seconds; // 1秒
        ...
        {
            var paths = DataConfigHelper.DataConfig.DelPaths;
            ...
            var config = DataConfigHelper.DataConfig.Config;
            if (config != null)
            {
        ...
        {
            var paths = DataConfigHelper.DataConfig.DelPaths.Where(x => x.Selected);

            var allow = DataConfigHelper.DataConfig.Config.Allow.Where(x => x.Selected);
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (DataConfigHelper.PathContains(textBox1.Text))
            {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            DataConfigHelper.SaveConfig(new Config
            {
            ...
            timer.Interval = DataConfigHelper.DataConfig.Config.Seconds; // 更新定时器间隔
            timer.Start();
        ...
        {
            var path = DataConfigHelper.GetPath(e.Index);
            DataConfigHelper.SetPathSelected(path, e.NewValue == CheckState.Checked);
        }
        ...
        private void button8_Click(object sender, EventArgs e)
        {
            ...
            for (int i = checkedListBox1.Items.Count - 1; i >= 0; i--)
            {
                if (checkedListBox1.SelectedIndices.Contains(i))
                {
                    var path = DataConfigHelper.GetPath(i);
        ...
        private void button9_Click(object sender, EventArgs e)
        {
            ...
            if (DataConfigHelper.DataConfig.Config.Allow.Select(x => x.Extension).Contains(allow))
            {
            ...
            try
            {
                DataConfigHelper.AddAllowExtension(allow);
        ...
        private void checkedListBox2_ItemCheck(object sender, ItemCheckEventArgs e)
        {
            ...
            DataConfigHelper.SetAllowSelected(allow, e.NewValue == CheckState.Checked);
        }
    }
}
